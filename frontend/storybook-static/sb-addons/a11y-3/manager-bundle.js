try {
	(() => {
		...
		var fa = (e, t) => {
			for (var a in t) pa(e, a, { get: t[a], enumerable: !0 });
		};
		var v = he(() => {});
		var x = he(() => {});
		var A = he(() => {});
		...
		fa(ct, {
			...
			StatelessTab: () => pn,
			StatelessTabList: () => fn,
			StatelessTabPanel: () => yn,
			StatelessTabsView: () => bn,
			StorybookIcon: () => hn,
			StorybookLogo: () => Sn,
			SyntaxHighlighter: () => Pe,
			TT: () => gn,
			TabBar: () => En,
			TabButton: () => In,
			TabList: () => vn,
			...
			codeCommon: () => Un,
			components: () => Hn,
			convertToReactAriaPlacement: () => Gn,
		...
		var N = "storybook/a11y",
			...
			ga = `${N}/manual`,
			Ea = `${N}/select`,
			Ia = "writing-tests/accessibility-testing",
			rt = `${Ia}#why-are-my-tests-failing-in-different-environments`,
			Z = {
				RESULT: ya,
				REQUEST: ba,
				RUNNING: ha,
		...
		var r = __REACT__,
			{
				...
				StrictMode: Do,
				Suspense: Lo,
				__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: Mo,
				act: Fo,
				cloneElement: J,
				createContext: te,
				createElement: d,
		...
		x();
		A();
		var rl = __STORYBOOK_API__,
			{
				ActiveTabs: ol,
				Consumer: ll,
				ManagerContext: il,
				Provider: sl,
				RequestResponseError: cl,
				addons: ge,
				combineParameters: ul,
				controlOrMetaKey: ml,
				controlOrMetaSymbol: dl,
				eventMatchesShortcut: pl,
				eventToShortcut: fl,
				experimental_MockUniversalStore: yl,
				experimental_UniversalStore: bl,
				experimental_getStatusStore: ut,
				experimental_getTestProviderStore: hl,
				experimental_requestResponse: Sl,
				experimental_useStatusStore: mt,
				experimental_useTestProviderStore: gl,
				experimental_useUniversalStore: El,
				internal_checklistStore: Il,
				internal_fullStatusStore: vl,
				internal_fullTestProviderStore: xl,
				internal_universalChecklistStore: Al,
				internal_universalStatusStore: $l,
				internal_universalTestProviderStore: Rl,
				isMacLike: _l,
				isShortcutTaken: Tl,
				keyToSymbol: Cl,
				merge: Ol,
				mockChannel: kl,
				optionOrAltSymbol: wl,
				shortcutMatchesShortcut: Nl,
				shortcutToAriaKeyshortcuts: Pl,
				shortcutToHumanString: Dl,
				types: Le,
				useAddonState: Ee,
				useArgTypes: Ll,
				useArgs: Ml,
		...
		x();
		A();
		var Yl = __STORYBOOK_ICONS__,
			{
				AccessibilityAltIcon: jl,
				AccessibilityIcon: bt,
				AccessibilityIgnoredIcon: Wl,
				AddIcon: zl,
				AdminIcon: Kl,
				AlertAltIcon: Xl,
				AlertIcon: Ql,
				...
				AlignRightIcon: Jl,
				AppleIcon: ei,
				ArrowBottomLeftIcon: ti,
				ArrowBottomRightIcon: ai,
				ArrowDownIcon: ni,
				ArrowLeftIcon: ri,
				ArrowRightIcon: oi,
				ArrowSolidDownIcon: li,
				ArrowSolidLeftIcon: ii,
				ArrowSolidRightIcon: si,
				ArrowSolidUpIcon: ci,
				ArrowTopLeftIcon: ui,
				ArrowTopRightIcon: mi,
				ArrowUpIcon: di,
				AzureDevOpsIcon: pi,
				BackIcon: fi,
				BasketIcon: yi,
				...
				BoldIcon: Ii,
				BookIcon: vi,
				BookmarkHollowIcon: xi,
				BookmarkIcon: Ai,
				BottomBarIcon: $i,
				BottomBarToggleIcon: Ri,
				BoxIcon: _i,
				BranchIcon: Ti,
				BrowserIcon: Ci,
				BugIcon: Oi,
				...
				ChevronLeftIcon: Gi,
				ChevronRightIcon: Bi,
				ChevronSmallDownIcon: St,
				ChevronSmallLeftIcon: qi,
				ChevronSmallRightIcon: Vi,
				ChevronSmallUpIcon: Yi,
				ChevronUpIcon: ji,
				ChromaticIcon: Wi,
				ChromeIcon: zi,
				CircleHollowIcon: Ki,
				...
				SideBySideIcon: yu,
				SidebarAltIcon: bu,
				SidebarAltToggleIcon: hu,
				SidebarIcon: Su,
				SidebarToggleIcon: gu,
				SortDownIcon: Eu,
				SortUpIcon: Iu,
				SpeakerIcon: vu,
				StackedIcon: xu,
		...
		var zm = __STORYBOOK_CORE_EVENTS__,
			{
				...
				FORCE_RE_RENDER: sd,
				GLOBALS_UPDATED: cd,
				MANAGER_INERT_ATTRIBUTE_CHANGED: ud,
				NAVIGATE_URL: md,
				OPEN_IN_EDITOR_REQUEST: dd,
				OPEN_IN_EDITOR_RESPONSE: pd,
				PLAY_FUNCTION_THREW_EXCEPTION: fd,
				PRELOAD_ENTRIES: yd,
				PREVIEW_BUILDER_PROGRESS: bd,
				PREVIEW_INITIALIZED: hd,
				PREVIEW_KEYDOWN: Sd,
				REGISTER_SUBSCRIPTION: gd,
				REQUEST_WHATS_NEW_DATA: Ed,
				RESET_STORY_ARGS: Id,
				RESULT_WHATS_NEW_DATA: vd,
				SAVE_STORY_REQUEST: xd,
				SAVE_STORY_RESPONSE: Ad,
				SELECT_STORY: $d,
				SET_CONFIG: Rd,
				SET_CURRENT_STORY: _d,
				SET_FILTER: Td,
				SET_GLOBALS: Cd,
				SET_INDEX: Od,
				SET_STORIES: kd,
				SET_WHATS_NEW_CACHE: wd,
				SHARED_STATE_CHANGED: Nd,
				SHARED_STATE_SET: Pd,
				STORIES_COLLAPSE_ALL: Dd,
				STORIES_EXPAND_ALL: Ld,
				STORY_ARGS_UPDATED: Md,
				STORY_CHANGED: Ct,
				STORY_ERRORED: Fd,
				STORY_FINISHED: Ot,
				STORY_HOT_UPDATED: kt,
				STORY_INDEX_INVALIDATED: Ud,
				STORY_MISSING: Hd,
				STORY_PREPARED: Gd,
				STORY_RENDERED: Bd,
				STORY_RENDER_PHASE_CHANGED: wt,
				STORY_SPECIFIED: qd,
				STORY_THREW_EXCEPTION: Vd,
				STORY_UNCHANGED: Yd,
				TELEMETRY_ERROR: jd,
				TOGGLE_WHATS_NEW_NOTIFICATIONS: Wd,
				UNHANDLED_ERRORS_WHILE_PLAYING: zd,
				UPDATE_GLOBALS: Kd,
		...
		x();
		A();
		var ve = "storybook/highlight",
			xe = `${ve}/add`,
			Ae = `${ve}/remove`,
			Kn = `${ve}/reset`,
			Me = `${ve}/scroll-into-view`;
		v();
		x();
		A();
		var lp = ((e) =>
		...
		var Sp = __REACT_DOM__,
			{
				...
				hydrateRoot: Ap,
				render: $p,
				unmountComponentAtNode: Rp,
				unstable_batchedUpdates: _p,
		...
		var H = {
			...
			Ht = { ...Xn, ...Qn, ...Zn, ...er, ...Jn, ...tr, ...ar },
			qe = (e) => Ht[e.id]?.title || e.id,
			Ve = (e) => Ht[e.id]?.friendlySummary || e.description,
			nr = ["html", "body", "main"],
			Fe = Rt(_t.light),
			Ue = {
				[H.VIOLATION]: Fe.color.negative,
				[H.PASS]: Fe.color.positive,
				[H.INCOMPLETION]: Fe.color.warning,
			},
			Gt = te({
				parameters: {},
				results: void 0,
			...
			rr = (e) => {
				let t = ft("a11y", {}),
					[a] = pt() ?? [],
					n = ie(),
					i = E((m = !1) => (m ? "manual" : "initial"), []),
					l = D(() => a?.a11y?.manual ?? !1, [a?.a11y?.manual]),
					o = D(() => {
						let m = n.getQueryParam("a11ySelection");
						return m && n.setQueryParams({ a11ySelection: "" }), m;
					}, [n]),
					[u, c] = Ee(N, {
						ui: { highlighted: !1, tab: H.VIOLATION },
						results: void 0,
						error: void 0,
						status: i(l),
					}),
					{ ui: s, results: p, error: y, status: S } = u,
					{ storyId: g } = yt(),
					h = mt((m) => m[g]?.[ot]?.value);
				k(
					() =>
						ut("storybook/component-test").onAllStatusChange((m, b) => {
							let f = m[g]?.[Oe],
								_ = b[g]?.[Oe];
							f?.value === "status-value:error" &&
				...
				let T = E(() => {
					...
					F = D(
						() => p?.[s.tab]?.every((m) => $.has(`${s.tab}.${m.id}`)) ?? !1,
						[p, $, s.tab],
					),
					ce = E((m, b, f) => {
						m.stopPropagation();
						let _ = `${b}.${f.id}`;
						R((O) => new Map(O.delete(_) ? O : O.set(_, `${_}.1`)));
					}, []),
					Q = E(() => {
						R(new Map());
					}, []),
					...
					ae = E(
						(m, b) => {
							g === b &&
								(c((f) => ({ ...f, status: "ran", results: m })),
								setTimeout(() => {
									c((f) =>
										f.status === "ran" ? { ...f, status: "ready" } : f,
									),
										R((f) => {
											if (f.size === 1) {
												let [_] = f.values();
					...
					ue = E(
						(m, b) => {
							let [f, _] = m.split("."),
								{ helpUrl: O, nodes: fe } =
									p?.[f]?.find((re) => re.id === _) || {},
								ye = O && window.open(O, "_blank", "noopener,noreferrer");
							if (fe && !ye) {
								let re =
									fe.findIndex((be) =>
										b.selectors.some((da) => da === String(be.target)),
									) ?? -1;
								if (re !== -1) {
									let be = `${f}.${_}.${re + 1}`;
									R(new Map([[`${f}.${_}`, be]])),
					...
					W = E(async (m) => {
						let { createCopyToClipboardFunction: b } =
							await Promise.resolve().then(() => (K(), ct));
				...
				k(() => {
					o &&
						c((m) => {
							let b = { ...m.ui, highlighted: !0 },
								[f] = o.split(".") ?? [];
							return (
								f && Object.values(H).includes(f) && (b.tab = f),
								{ ...m, ui: b }
							);
						});
				}, [o]),
					k(() => {
						if (
							...
							return;
						let m = Array.from($.values()).flatMap((f) => {
							let [_, O, fe] = f.split(".");
							if (_ !== s.tab) return [];
							let ye = p?.[_]?.find((re) => re.id === O)?.nodes[Number(fe) - 1]
								?.target;
							return ye ? [String(ye)] : [];
						});
						m.length &&
							Y(xe, {
								...
								selectors: m,
								styles: {
									outline: `1px solid color-mix(in srgb, ${Ue[s.tab]}, transparent 30%)`,
						...
						let b = p?.[s.tab]
							.flatMap((f) => f.nodes.flatMap((_) => _.target).map(String))
							.filter((f) => ![...nr, ...m].includes(f));
						b?.length &&
							Y(xe, {
								id: `${N}/others`,
								selectors: b,
								styles: {
									outline: `1px solid color-mix(in srgb, ${Ue[s.tab]}, transparent 30%)`,
									backgroundColor: `color-mix(in srgb, ${Ue[s.tab]}, transparent 60%)`,
								},
								hoverStyles: { outlineWidth: "2px" },
								focusStyles: { backgroundColor: "transparent" },
								menu: p?.[s.tab].map((f) => {
					...
					}, [at, Y, s.highlighted, p, s.tab, $]);
				let ma = D(() => {
					if (!h) return null;
					if (h === "status-value:success" && p?.violations.length)
						return "cliPassedBrowserFailed";
					if (h === "status-value:error" && !p?.violations.length) {
						if (S === "ready" || S === "ran") return "browserPassedCliFailed";
						if (S === "manual") return "cliFailedButModeManual";
					}
					return null;
				}, [p?.violations.length, S, h]);
				return r.createElement(Gt.Provider, {
					value: {
						parameters: t,
						results: p,
						...
						handleCollapseAll: Q,
						handleExpandAll: Te,
						handleJumpToElement: ua,
						handleSelectionChange: de,
					},
					...e,
				});
			},
		...
		function Qe(e, t = []) {
			...
			function n(l, o) {
				...
				a = [...a, o];
				function s(y) {
					let { scope: S, children: g, ...h } = y,
						T = S?.[e][c] || u,
						$ = D(() => h, Object.values(h));
					return d(T.Provider, { value: $ }, g);
				}
				function p(y, S) {
					let g = S?.[e][c] || u,
						h = le(g);
			...
			return (i.scopeName = e), [n, or(i, ...t)];
		}
		function or(...e) {
			let t = e[0];
			if (e.length === 1) return t;
			let a = () => {
				let n = e.map((i) => ({ useScope: i(), scopeName: i.scopeName }));
				return function (i) {
					let l = n.reduce((o, { useScope: u, scopeName: c }) => {
						let s = u(i)[`__scope${c}`];
						return { ...o, ...s };
					}, {});
					return D(() => ({ [`__scope${t.scopeName}`]: l }), [l]);
				};
			};
		...
		var Ye = w((e, t) => {
			...
			if (l) {
				...
				return d(je, P({}, n, { ref: t }), j(o) ? J(o, void 0, u) : null);
			}
			return d(je, P({}, n, { ref: t }), a);
		});
		Ye.displayName = "Slot";
		var je = w((e, t) => {
			let { children: a, ...n } = e;
			return j(a)
				? J(a, { ...cr(n, a.props), ref: t ? Ze(t, a.ref) : a.ref })
				: U.count(a) > 1
					? U.only(null)
					: null;
		});
		je.displayName = "SlotClone";
		var ir = ({ children: e }) => d(oe, null, e);
		function sr(e) {
			return j(e) && e.type === ir;
		}
		function cr(e, t) {
			let a = { ...t };
			for (let n in t) {
				...
				/^on[A-Z]/.test(n)
					...
					: n === "style"
						? (a[n] = { ...i, ...l })
						: n === "className" && (a[n] = [i, l].filter(Boolean).join(" "));
			}
			return { ...e, ...a };
		}
		function ur(e) {
			let t = e + "CollectionProvider",
				[a, n] = Qe(t),
				[i, l] = a(t, { collectionRef: { current: null }, itemMap: new Map() }),
				o = (g) => {
					let { scope: h, children: T } = g,
						$ = r.useRef(null),
						R = r.useRef(new Map()).current;
					return r.createElement(
						i,
						{ scope: h, itemMap: R, collectionRef: $ },
						T,
					);
				};
			...
			let u = e + "CollectionSlot",
				c = r.forwardRef((g, h) => {
					let { scope: T, children: $ } = g,
						R = l(u, T),
						F = Re(h, R.collectionRef);
					return r.createElement(Ye, { ref: F }, $);
				});
			Object.assign(c, { displayName: u });
			let s = e + "CollectionItemSlot",
				p = "data-radix-collection-item",
				y = r.forwardRef((g, h) => {
					let { scope: T, children: $, ...R } = g,
						F = r.useRef(null),
						ce = Re(h, F),
						Q = l(s, T);
					return (
						r.useEffect(
							() => (
								Q.itemMap.set(F, { ref: F, ...R }),
								() => void Q.itemMap.delete(F)
							),
						),
						r.createElement(Ye, { [p]: "", ref: ce }, $)
					);
				});
			Object.assign(y, { displayName: s });
			function S(g) {
				let h = l(e + "CollectionConsumer", g);
				return r.useCallback(() => {
					let T = h.collectionRef.current;
					if (!T) return [];
					let $ = Array.from(T.querySelectorAll(`[${p}]`));
					return Array.from(h.itemMap.values()).sort(
						(R, F) => $.indexOf(R.ref.current) - $.indexOf(F.ref.current),
					);
				}, [h.collectionRef, h.itemMap]);
			}
			return [{ Provider: o, Slot: c, ItemSlot: y }, S, n];
		}
		var We = globalThis?.document ? it : () => {},
			mr = lt || (() => {}),
			dr = 0;
		function Bt(e) {
			let [t, a] = L(mr());
		...
		var qt = w((e, t) => {
			...
			if (l) {
				...
				return d(ze, P({}, n, { ref: t }), j(o) ? J(o, void 0, u) : null);
			}
			return d(ze, P({}, n, { ref: t }), a);
		});
		qt.displayName = "Slot";
		var ze = w((e, t) => {
			let { children: a, ...n } = e;
			return j(a)
				? J(a, { ...yr(n, a.props), ref: t ? Ze(t, a.ref) : a.ref })
				: U.count(a) > 1
					? U.only(null)
					: null;
		});
		ze.displayName = "SlotClone";
		var pr = ({ children: e }) => d(oe, null, e);
		function fr(e) {
			return j(e) && e.type === pr;
		}
		function yr(e, t) {
			let a = { ...t };
			for (let n in t) {
		...
		function Vt({ prop: e, defaultProp: t, onChange: a = () => {} }) {
			let [n, i] = hr({ defaultProp: t, onChange: a }),
				l = e !== void 0,
				o = l ? e : n,
				u = Je(a),
				c = E(
		...
		Object.assign(zt, { displayName: _e });
		var Ar = w((e, t) => {
				let {
					...
					S = Re(t, y),
					g = Yt(l),
					[h = null, T] = Vt({ prop: o, defaultProp: u, onChange: c }),
					[$, R] = L(!1),
					F = Je(s),
					ce = jt(a),
					Q = V(!1),
				...
				return (
					k(() => {
						...
						if (C)
							return (
								C.addEventListener(He, F), () => C.removeEventListener(He, F)
							);
					}, [F]),
					d(
						vr,
						{
							...
							onItemShiftTab: E(() => R(!0), []),
							onFocusableItemAdd: E(() => de((C) => C + 1), []),
							onFocusableItemRemove: E(() => de((C) => C - 1), []),
						},
						d(
							se.div,
							P(
								{ tabIndex: $ || Te === 0 ? -1 : 0, "data-orientation": n },
								p,
								{
									ref: S,
									...
									onFocus: X(e.onFocus, (C) => {
										...
										if (C.target === C.currentTarget && ae && !$) {
											let ue = new CustomEvent(He, gr);
											if (
												(C.currentTarget.dispatchEvent(ue),
												!ue.defaultPrevented)
											) {
												let ne = ce().filter((W) => W.focusable),
													pe = ne.find((W) => W.active),
													Y = ne.find((W) => W.id === h),
													Ce = [pe, Y, ...ne]
														.filter(Boolean)
														.map((W) => W.ref.current);
			...
			Xt = w((e, t) => {
				...
				return (
					...
					d(
						Ke.ItemSlot,
						{ scope: a, id: c, focusable: n, active: i },
						d(
							se.span,
							P(
								{ tabIndex: p ? 0 : -1, "data-orientation": s.orientation },
								o,
								{
									ref: t,
									onMouseDown: X(e.onMouseDown, (h) => {
										n ? s.onItemFocus(c) : h.preventDefault();
									}),
									...
									onKeyDown: X(e.onKeyDown, (h) => {
										...
										let T = _r(h, s.orientation, s.dir);
										if (T !== void 0) {
											h.preventDefault();
											let $ = y()
											...
											if (T === "last") $.reverse();
												...
												T === "prev" && $.reverse();
												let R = $.indexOf(h.currentTarget);
												$ = s.loop ? Tr($, R + 1) : $.slice(R + 1);
											}
											setTimeout(() => Qt($));
										}
									}),
		...
		Object.assign(Xt, { displayName: Kt });
		var $r = {
			ArrowLeft: "prev",
			ArrowUp: "prev",
			ArrowRight: "next",
		...
		var Cr = zt,
			Or = Xt;
		function kr(e, t) {
			return st((a, n) => t[a][n] ?? a, e);
		}
		var Zt = (e) => {
			let { present: t, children: a } = e,
				n = wr(t),
				i = typeof a == "function" ? a({ present: n.isPresent }) : U.only(a),
				l = Re(n.ref, i.ref);
			return typeof a == "function" || n.isPresent ? J(i, { ref: l }) : null;
		};
		...
		function wr(e) {
			...
			return (
				...
				We(() => {
					if (t) {
						let s = (y) => {
								let S = $e(n.current).includes(y.animationName);
								y.target === t && S && Nt(() => c("ANIMATION_END"));
							},
							p = (y) => {
								y.target === t && (l.current = $e(n.current));
							};
						return (
		...
		var et = "Tabs",
			...
			ea = w((e, t) => {
				let {
					...
					p = Yt(u),
					[y, S] = Vt({ prop: n, onChange: i, defaultProp: l });
				return d(
					Pr,
					{
						scope: a,
					...
					d(se.div, P({ dir: p, "data-orientation": o }, s, { ref: t })),
				);
			});
		Object.assign(ea, { displayName: et });
		var ta = "TabsList",
			aa = w((e, t) => {
				let { __scopeTabs: a, loop: n = !0, ...i } = e,
					l = tt(ta, a),
					o = Jt(a);
				return d(
					Cr,
					...
					d(
						se.div,
						P({ role: "tablist", "aria-orientation": l.orientation }, i, {
							ref: t,
						}),
					),
				);
			});
		Object.assign(aa, { displayName: ta });
		var na = "TabsTrigger",
			ra = w((e, t) => {
				let { __scopeTabs: a, value: n, disabled: i = !1, ...l } = e,
					o = tt(na, a),
					u = Jt(a),
					c = ia(o.baseId, n),
					s = sa(o.baseId, n),
				...
				return d(
					Or,
					P({ asChild: !0 }, u, { focusable: !i, active: p }),
					d(
						se.button,
						P(
							{
							...
							l,
							{
								...
								onMouseDown: X(e.onMouseDown, (y) => {
									!i && y.button === 0 && y.ctrlKey === !1
										? o.onValueChange(n)
										: y.preventDefault();
								}),
								onKeyDown: X(e.onKeyDown, (y) => {
									[" ", "Enter"].includes(y.key) && o.onValueChange(n);
								}),
								onFocus: X(e.onFocus, () => {
									let y = o.activationMode !== "manual";
									!p && !i && y && o.onValueChange(n);
								}),
							},
						),
					),
		...
		Object.assign(ra, { displayName: na });
		var oa = "TabsContent",
			la = w((e, t) => {
				let { __scopeTabs: a, value: n, forceMount: i, children: l, ...o } = e,
					u = tt(oa, a),
					c = ia(u.baseId, n),
					s = sa(u.baseId, n),
					p = n === u.value,
				...
				return (
					k(() => {
						let S = requestAnimationFrame(() => (y.current = !1));
						return () => cancelAnimationFrame(S);
					}, []),
					d(Zt, { present: i || p }, ({ present: S }) =>
						d(
							se.div,
							P(
								{
		...
		var Dr = ea,
			...
			Fr = I.div({ display: "flex", flexDirection: "column" }),
			Ur = I.div(({ theme: e }) => ({
				display: "block",
			...
			Vr = I.div({ display: "flex", flexDirection: "column", gap: 10 }),
			Yr = I.div({ display: "flex", gap: 10 }),
			jr = ({ onClick: e }) => {
				let [t, a] = L(!1),
					n = E(() => {
						e(), a(!0);
						let i = setTimeout(() => a(!1), 2e3);
						return () => clearTimeout(i);
					}, [e]);
				return r.createElement(
					M,
					{ ariaLabel: !1, onClick: n },
					t ? r.createElement(ht, null) : r.createElement(Et, null),
					" ",
					t ? "Copied" : "Copy link",
				);
			},
						...
						r.createElement(
								...
								t.nodes.map((l, o) => {
									...
									return r.createElement(
										...
										r.createElement(
											Pt,
											{ value: u, asChild: !0 },
											r.createElement(Lt, { side: "left" }, Mt(l)),
										),
									);
								}),
							),
							t.nodes.map((l, o) => {
								...
								return r.createElement(
									...
									r.createElement(Lt, { side: "right" }, Mt(l)),
								);
							}),
						),
					),
		...
		function Mt(e) {
			let { handleCopyLink: t, handleJumpToElement: a } = Xe(),
				{ any: n, all: i, none: l, html: o, target: u } = e,
				c = [...n, ...i, ...l];
			return r.createElement(
				r.Fragment,
				null,
				...
				r.createElement(
					...
					r.createElement(jr, { onClick: () => t(e.linkPath) }),
				),
				r.createElement(
					Dt,
...
${u} {}`,
		...
		var zr = {
			...
			Qr = I(St)({ transition: "transform 0.1s ease-in-out" }),
			Zr = I.div(({ theme: e }) => ({
				display: "flex",
					...
					e && e.length
						? e.map((o) => {
								...
								return r.createElement(
									...
									r.createElement(
										Zr,
										{ onClick: (y) => l(y, a, o), "data-active": !!s },
										r.createElement(
											Jr,
											null,
											r.createElement("strong", null, p),
											r.createElement(eo, null, o.id),
										),
										o.impact &&
											r.createElement(
												z,
												{ status: a === H.PASS ? "neutral" : zr[o.impact] },
												Kr[o.impact],
											),
										r.createElement(to, null, o.nodes.length),
										r.createElement(
											M,
											{
												onClick: (y) => l(y, a, o),
												ariaLabel: `${s ? "Collapse" : "Expand"} details for: ${p}`,
												"aria-expanded": !!s,
												"aria-controls": c,
												variant: "ghost",
												padding: "small",
									...
									s
										...
										: r.createElement("div", { id: c }),
								);
							})
						: r.createElement(we, { title: t }),
				),
			ao = I.div({
				width: "100%",
				position: "relative",
			...
			oo = I.div(({ theme: { color: e, typography: t, background: a } }) => ({
				textAlign: "start",
				padding: "11px 15px",
			...
			lo = ({ discrepancy: e }) => {
				let t = ie().getDocsUrl({ subpath: rt, versioned: !0, renderer: !0 }),
					a = D(() => {
						switch (e) {
			...
			Be = I.div({ display: "flex", alignItems: "center", gap: 6 }),
			Ut = I.span(({ theme: e }) => ({
				display: "flex",
				flexDirection: "column",
				alignItems: "center",
			...
			io = () => {
				...
				return e.disable || e.test === "off"
					...
					: r.createElement(
							r.Fragment,
							null,
							o && r.createElement(lo, { discrepancy: o }),
							n === "ready" || n === "ran"
								? r.createElement(ro, { key: "tabs", tabs: p })
								: r.createElement(
										Ut,
										...
										n === "manual" &&
											r.createElement(
												...
												r.createElement(
													M,
													{ ariaLabel: !1, size: "medium", onClick: i },
												...
												r.createElement(
													...
													null,
													"Update ",
													r.createElement("code", null, "globals.a11y.manual"),
				...
				e
					? e === "blurred vision"
						...
						: e === "grayscale"
							...
							: `url('#${e}')`
					: "none",
			mo = I.div({ "&, & svg": { position: "absolute", width: 0, height: 0 } }),
			po = I.span(
				{
					background:
			...
			fo = () => {
				let [e, t] = L(null),
					a = uo.map(({ name: n, percentage: i }) => {
						let l = i !== void 0 ? `${i}% of users` : void 0;
						return {
							title: n,
							description: l,
							icon: r.createElement(po, { $filter: n }),
							value: n,
						};
					});
				return r.createElement(
					...
					r.createElement(Ne, {
						...
						defaultOptions: e?.name,
						options: a,
						onSelect: (n) => t(() => ({ name: n })),
					}),
					r.createElement(mo, null, r.createElement(so, null)),
				);
			},
			yo = () => {
				let e = ie().getSelectedPanel(),
					...
					l =
						i === 0
							...
							: r.createElement(
									z,
									{ compact: !0, status: e === Se ? "active" : "neutral" },
									i,
								);
				return r.createElement(
					"div",
					{ style: { display: "flex", alignItems: "center", gap: 6 } },
					r.createElement("span", null, "Accessibility"),
					l,
				);
			};
		ge.register(N, (e) => {
			ge.add(Se, {
				...
				render: () => r.createElement(fo, null),
			}),
				ge.add(Se, {
					title: yo,
					type: Le.PANEL,
					render: ({ active: t = !0 }) =>
						r.createElement(rr, null, t ? r.createElement(io, null) : null),
					paramKey: nt,
				});
		});
	})();
