...
import { d as u } from "./design-system-CwcdUVvG.js";
import "./preload-helper-PPVm8Dsz.js";
var M = s(
		'<svg aria-hidden=true class="h-5 w-5"fill=currentColor viewBox="0 0 20 20"><path fill-rule=evenodd d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"clip-rule=evenodd>',
	),
	V = s(
		'<svg aria-hidden=true class="h-5 w-5"fill=currentColor viewBox="0 0 20 20"><path fill-rule=evenodd d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"clip-rule=evenodd>',
	),
	q = s(
	...
	I = s(
		'<svg aria-hidden=true class="h-5 w-5"fill=currentColor viewBox="0 0 20 20"><path fill-rule=evenodd d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"clip-rule=evenodd>',
	),
	B = s('<h3 class="font-medium text-sm">'),
	H = s(
		'<button type=button><svg aria-hidden=true class="h-5 w-5"fill=none stroke=currentColor viewBox="0 0 24 24"><path stroke-linecap=round stroke-linejoin=round stroke-width=2 d="M6 18L18 6M6 6l12 12">',
	),
	N = s('<div role=alert><div></div><div class="min-w-0 flex-1"><div>');
const O = {
...
function i(n) {
	const [a, T] = P(n, ["variant", "title", "children", "class", "onClose"]),
		o = a.variant ?? "info";
	return (() => {
		var d = N(),
			l = d.firstChild,
		...
		return (
			...
			e(
				...
				t(c, {
					...
					get children() {
						var r = H();
						return (
							E(r, "click", a.onClose, !0),
							k(() => _(r, u("ml-auto shrink-0", W[o], "hover:opacity-70"))),
							r
						);
					},
				}),
			...
			k(
				(r) => {
					var C = u("mt-0.5 shrink-0", W[o]),
						$ = u("text-sm", a.title && "mt-1");
					return C !== r.e && _(l, (r.e = C)), $ !== r.t && _(S, (r.t = $)), r;
				},
				{ e: void 0, t: void 0 },
			),
			d
...
var R = s("<div style=width:500px>"),
	j = s("<div style=display:flex;flex-direction:column;gap:16px>");
const D = {
				...
				return (
					...
					e(
						...
						t(i, {
							variant: "info",
							title: "Information",
							children: "Here's something you should know.",
						}),
						null,
					),
					n
