...
export const card = {
	base: "bg-white rounded-2xl border border-neutral-200",
	default: "bg-white rounded-2xl border border-neutral-200 p-6",
	hover:
		"bg-white rounded-2xl border border-neutral-200 hover:border-neutral-300 hover:shadow-sm transition-all",
};

export const input = {
	base: "block w-full rounded-lg border border-neutral-300 px-3 py-2 text-neutral-900 placeholder-neutral-400 focus:border-primary-light focus:outline-none focus:ring-1 focus:ring-primary-light",
	text: "block w-full rounded-lg border border-neutral-300 px-3 py-2 text-neutral-900 placeholder-neutral-400 focus:border-primary-light focus:outline-none focus:ring-1 focus:ring-primary-light",
	textarea:
		"block w-full rounded-lg border border-neutral-300 px-3 py-2 text-neutral-900 placeholder-neutral-400 focus:border-primary-light focus:outline-none focus:ring-1 focus:ring-primary-light resize-none",
	select:
		"block w-full rounded-lg border border-neutral-300 px-3 py-2 text-neutral-900 focus:border-primary-light focus:outline-none focus:ring-1 focus:ring-primary-light",
};
