...
export const input = {
  // Standard text input
  text:
    "w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent disabled:bg-gray-50 disabled:cursor-not-allowed",
...
export const alert = {
  // Alert boxes
  success: "flex items-start space-x-3 p-3 bg-green-50 rounded-lg border border-green-200",
  warning: "flex items-start space-x-3 p-3 bg-yellow-50 rounded-lg border border-yellow-200",
  error: "flex items-start space-x-3 p-3 bg-red-50 rounded-lg border border-red-200",
  info: "flex items-start space-x-3 p-3 bg-blue-50 rounded-lg border border-blue-200",
};

export const link = {
  // Standard link
  default: "text-purple-600 hover:text-purple-700 font-medium transition-colors",
