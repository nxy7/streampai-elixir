...
import { Alert, Button, Card, Input, Skeleton, Toggle } from "~/design-system";
	...
	return (
		<div class="mx-auto max-w-6xl space-y-6">
			...
			<Show when={paymentSuccess()}>
				<Alert variant="success">{t("settings.paymentSuccess")}</Alert>
			</Show>
			<Show when={paymentPending()}>
				<Alert variant="warning">{t("settings.paymentPending")}</Alert>
			</Show>
