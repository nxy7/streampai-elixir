				...
				<Card variant="ghost">
					<div class="divide-y divide-neutral-800/50">
						...
						<div
							...
							classList={{
								"grid-rows-[1fr] opacity-100": form.ai_chat_enabled,
								"grid-rows-[0fr] opacity-0": !form.ai_chat_enabled,
							}}>
							<div class="overflow-hidden">
								<div class="ml-3 space-y-3 py-2 pl-3">
									<Textarea
