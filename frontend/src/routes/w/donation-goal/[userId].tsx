...
export default function DonationGoalWidgetDisplay() {
  ...
  return (
    <div style={{ background: "transparent", width: "100vw", height: "100vh", display: "flex", "align-items": "center", "justify-content": "center", padding: "1rem" }}>
      <Show when={config()}>
        <div style={{ "max-width": "600px", width: "100%" }}>
          <DonationGoalWidget config={config()!} currentAmount={config()!.startingAmount} />
        </div>
      </Show>
    </div>
  );
