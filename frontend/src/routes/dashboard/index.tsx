  ...
  return (
    <>
      ...
      >
          ...
          fallback={
            <div class="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center">
              <div class="text-center py-12">
                ...
                <p class="text-gray-300 mb-6">Please sign in to access the dashboard.</p>
                <a
                  href={getLoginUrl()}
        ...
        >
          <DashboardLayout pageTitle="Dashboard" currentPage="dashboard">
              <div class="space-y-6">
                <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
                  <h1 class="text-3xl font-bold text-gray-900 mb-2">
                    {greeting}, {user()?.name || "Streamer"}!
                  </h1>
                  <p class="text-gray-600">Welcome to your Streampai dashboard.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    ...
                    <div class="space-y-2 text-sm">
                      ...
                      <Show when={user()?.hoursStreamedLast30Days !== null && user()?.hoursStreamedLast30Days !== undefined}>
                        <div>
                          <span class="text-gray-600">Hours Streamed (30d):</span>
                          <span class="text-gray-900 ml-2">{user()?.hoursStreamedLast30Days}h</span>
                        </div>
                      </Show>
                    </div>
                  </div>
                  ...
                  <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    ...
                    <p class="text-gray-700 text-sm">
                      Stream management features coming soon. Connect your platforms and go live across multiple services.
                    </p>
                  </div>
                  ...
                  <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    ...
                    <p class="text-gray-700 text-sm">
                      Track your growth across all platforms with detailed analytics and insights.
                    </p>
                  </div>

                  <Show when={user()?.storageQuota !== null && user()?.storageQuota !== undefined}>
                    <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                      <div class="flex items-center space-x-3 mb-4">
                      ...
                      <div class="space-y-2">
                        <div class="flex justify-between text-sm">
                          ...
                          <span class="text-gray-900">{user()?.storageUsedPercent?.toFixed(1)}%</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2">
                          <div
                            class="bg-gradient-to-r from-purple-500 to-pink-500 h-2 rounded-full transition-all"
                            style={{ width: `${Math.min(user()?.storageUsedPercent || 0, 100)}%` }}
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    ...
                    <p class="text-gray-700 text-sm">
                      Beautiful, customizable widgets for donations, follows, chat, and more.
                    </p>
                  </div>
                  ...
                  <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    <div class="flex items-center space-x-3 mb-4">
                      ...
                      <div>
                        ...
                        <p class="text-gray-600 text-sm">Configure your account</p>
                      </div>
                    </div>
                    <p class="text-gray-700 text-sm">
                ...
                <div class="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-2xl p-8">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="flex items-start space-x-3">
                      ...
                      <div>
                        <h3 class="text-gray-900 font-semibold mb-1">Connect Platforms</h3>
                        <p class="text-gray-700 text-sm">
                    ...
                    <div class="flex items-start space-x-3">
                      ...
                      <div>
                        <h3 class="text-gray-900 font-semibold mb-1">Configure Your Stream</h3>
                        <p class="text-gray-700 text-sm">
