...
export const Route = createFileRoute("/dashboard/viewers/")({
	component: Viewers,
	head: () => ({
		meta: [{ title: "Viewers - Streampai" }],
	}),
});
								...
								<Show
										...
										<For each={viewers()}>
											{(viewer) => (
												<button
													...
													onClick={() =>
														navigate({
															to: `/dashboard/viewers/${viewer.viewerId}`,
														})
													}
													type="button">
													<div class="flex items-start gap-3">
									...
									<Show when={hasMore()}>
										<div class="mt-6 text-center">
											<Button disabled={isLoadingViewers()} onClick={loadMore}>
