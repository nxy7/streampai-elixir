...
export const Route = createFileRoute("/dashboard/stream-history/$id")({
	component: StreamHistoryDetail,
	head: () => ({
		meta: [{ title: "Stream Details - Streampai" }],
	}),
});

function StreamHistoryDetail() {
					...
					<Card variant="ghost">
						...
						<div class="space-y-4">
							<div class="rounded-lg bg-primary/10 p-4">
								<h4 class="mb-2 font-medium text-primary">Peak Moment</h4>
							...
							<div class="rounded-lg bg-blue-500/10 p-4">
								<h4 class="mb-2 font-medium text-blue-500 dark:text-blue-400">
									Chat Activity
								</h4>
								<p class="text-sm opacity-80">
