  ...
  return (
    <>
      ...
      >
          ...
          fallback={
            <div class="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center">
              <div class="text-center py-12">
                ...
                <p class="text-gray-300 mb-6">Please sign in to access settings.</p>
                <a
                  href={getLoginUrl()}
        ...
        >
          <DashboardLayout pageTitle="Settings" currentPage="settings">
                        ...
                        {(connection) => (
                          <div class="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                            <div class="flex items-center space-x-3">
                              <div class={`w-10 h-10 bg-gradient-to-r ${connection.color} rounded-lg flex items-center justify-center`}>
                ...
                <div class="space-y-4">
                  ...
                  <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg border">
                    <div class="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 class="font-medium text-gray-900">Support {user()?.name}</h4>
              ...
              <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <form class="space-y-4">
                  ...
                  <div>
                    ...
                    <select class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                      <option value="random">🎲 Random (different voice each time)</option>
                      <option value="google_en_us_male">Google TTS - English (US) Male</option>
                      <option value="google_en_us_female">Google TTS - English (US) Female</option>
                    </select>
                    <p class="text-xs text-gray-500 mt-1">
