				...
				<div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
					<div class="rounded-2xl bg-neutral-50 p-8">
						<div class="prose prose-invert max-w-none">
							...
							<p class="mb-4 text-neutral-600">{t("privacy.section1Intro")}</p>
							...
							<p class="mb-4 text-neutral-600">{t("privacy.section2Intro")}</p>
							<ul class="mb-6 list-disc space-y-2 pl-6 text-neutral-600">
							...
							<p class="mb-4 text-neutral-600">{t("privacy.section3Intro")}</p>
							<ul class="mb-6 list-disc space-y-2 pl-6 text-neutral-600">
							...
							<p class="mb-4 text-neutral-600">{t("privacy.section7Intro")}</p>
							<ul class="mb-6 list-disc space-y-2 pl-6 text-neutral-600">
							...
							<p class="mb-6 text-neutral-600">{t("privacy.section10Text")}</p>
