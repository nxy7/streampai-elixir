...
export const dict: Dictionary = {
	...
	analytics: {
		...
		metricViewers: "Espectadores",
		metricStreams: "Streams",
		metricActivity: "Actividad",
		metricIncome: "Ingresos",
		totalStreams: "Total de streams",
		avgStreamsPerDay: "Promedio por día",
		avgStreamDuration: "Duración promedio",
		totalDuration: "Duración total",
		totalActivity: "Total de mensajes",
		avgActivityPerStream: "Promedio por stream",
		peakActivity: "Pico de mensajes",
		noStreams: "Sin streams",
		totalIncome: "Ingresos totales",
		avgIncomePerStream: "Promedio por stream",
		peakIncome: "Ingreso máximo",
		// Empty states
	...
	auth: {
		...
		alreadyLoggedIn: "Conectado como {{name}}",
	...
	donation: {
		...
		yourEmail: "Tu correo (para recibo)",
