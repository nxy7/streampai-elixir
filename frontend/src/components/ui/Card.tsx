...
const variantClasses: Record<CardVariant, string> = {
	default: "bg-theme-surface border border-theme shadow-sm",
	interactive:
		"bg-theme-surface border border-theme shadow-sm hover:shadow-md transition-shadow cursor-pointer",
	gradient: "bg-linear-to-r from-purple-600 to-pink-600 shadow-sm text-white",
	outline: "bg-transparent border border-theme",
};
...
export function CardHeader(props: CardHeaderProps) {
	...
	return (
		<div
			class={cn("border-theme border-b px-6 py-4", local.class)}
			{...rest}>
			{local.children}
		</div>
	);
...
export function CardTitle(props: CardTitleProps) {
	...
	return (
		<h3 class={cn("font-medium text-theme-primary text-lg", local.class)} {...rest}>
			{local.children}
		</h3>
	);
}
