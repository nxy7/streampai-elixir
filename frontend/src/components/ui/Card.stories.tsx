...
export const Default: Story = {
  args: {
    children: (
      <div>
        <h3 style={{ margin: "0 0 8px 0", "font-weight": "600" }}>Card Title</h3>
        <p style={{ margin: 0, color: "#6b7280" }}>
          This is a default card with some content inside. Cards are used to group related information.
        </p>
      </div>
    ),
  },
...
export const Interactive: Story = {
  args: {
    ...
    children: (
      <div>
        <h3 style={{ margin: "0 0 8px 0", "font-weight": "600" }}>Clickable Card</h3>
        <p style={{ margin: 0, color: "#6b7280" }}>
...
export const Gradient: Story = {
  args: {
    ...
    children: (
      <div>
        <h3 style={{ margin: "0 0 8px 0", "font-weight": "600" }}>Premium Feature</h3>
...
export const Outline: Story = {
  args: {
    ...
    children: (
      <div>
        <h3 style={{ margin: "0 0 8px 0", "font-weight": "600" }}>Outline Card</h3>
        <p style={{ margin: 0, color: "#6b7280" }}>
...
export const WithHeaderAndContent: Story = {
  render: () => (
    <Card padding="none">
      ...
      <CardContent>
        <p style={{ margin: 0, color: "#6b7280" }}>
          Configure your stream settings here. You can change the title, description, and other options.
        </p>
