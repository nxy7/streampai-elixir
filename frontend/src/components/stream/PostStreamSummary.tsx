				...
				<div class="divide-y divide-neutral-100">
					<div class="flex items-center justify-between p-4">
						<div class="flex items-center gap-3">
							...
							<div>
								<div class="font-medium text-neutral-900">Donations</div>
					...
					<div class="flex items-center justify-between p-4">
						<div class="flex items-center gap-3">
							...
							<div>
								<div class="font-medium text-neutral-900">New Followers</div>
								<div class="text-neutral-500 text-sm">People who followed</div>
							</div>
						</div>
					...
					<div class="flex items-center justify-between p-4">
						<div class="flex items-center gap-3">
							<div class="flex h-10 w-10 items-center justify-center rounded-lg bg-primary-100 text-primary">
								*
							</div>
							<div>
								<div class="font-medium text-neutral-900">New Subscribers</div>
								<div class="text-neutral-500 text-sm">Paid subscriptions</div>
							</div>
						</div>
					...
					<div class="flex items-center justify-between p-4">
						<div class="flex items-center gap-3">
							...
							<div>
								<div class="font-medium text-neutral-900">Raids</div>
								<div class="text-neutral-500 text-sm">Incoming raids</div>
							</div>
						</div>
