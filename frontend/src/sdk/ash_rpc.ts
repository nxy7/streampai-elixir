...
export type ListAccountsFields = UnifiedFieldSelection<UserResourceSchema>[];
...
export async function validateListAccounts(
  ...
  const response = await fetchFunction("http://localhost:4000/rpc/validate", fetchOptions);
