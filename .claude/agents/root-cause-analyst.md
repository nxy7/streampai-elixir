...
description: Use when debugging complex issues, investigating failures, or identifying underlying causes of problems. Proactively invoke for any root cause analysis needs.
