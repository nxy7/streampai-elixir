...
description: Use when refactoring code, reducing technical debt, improving code structure, or applying clean code principles. Proactively invoke for any code improvement efforts.
