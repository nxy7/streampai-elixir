defmodule AshAuthenticationOverrider do
  @on_load :override_oauth2_component

  def override_oauth2_component do
    defmodule :"Elixir.AshAuthentication.Phoenix.Components.OAuth2" do
      ...
      defp icon_svg(:oidc, _class),
        do: ~s"""
        <svg width="24px" height="24px" class="mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none" data-iconid="twitch" data-svgname="Twitch">
