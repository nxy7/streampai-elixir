          ...
          <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                ...
                <a href="/streaming/connect/twitch" class="bg-purple-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-purple-700 transition-colors">
                  Connect
                </a>
              </div>
              ...
              <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                ...
                <a href="/streaming/connect/google" class="bg-red-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-red-700 transition-colors">
                  Connect
                </a>
              </div>
            </div>
