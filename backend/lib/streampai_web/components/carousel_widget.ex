defmodule StreampaiWeb.Components.CarouselWidget do
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok, 
     ...
     |> assign(:transition_duration, 5000) # 5 seconds per slide
              ...
              <%= for index <- 0..(length(@images) - 1) do %>
                <button 
                  ...
                  class={[
                    ...
                    if(index == @current_index, do: "bg-purple-400", else: "bg-gray-500 hover:bg-gray-400")
                  ]}
          ...
          <div class="flex items-center space-x-2 text-xs text-gray-300">
            ...
            <button 
              ...
              class={[
                ...
                if(@auto_play, do: "text-purple-400 hover:text-purple-300", else: "text-gray-400 hover:text-gray-300")
              ]}
