defmodule StreampaiWeb.Components.LandingFeatures do
  ...
  def landing_features(assigns) do
    ...
    <!-- Streampai Donations - Coming Soon -->
          <div class="bg-gradient-to-br from-green-500/10 to-emerald-500/10 backdrop-blur-lg border-2 border-green-500/30 rounded-2xl p-8 hover:from-green-500/20 hover:to-emerald-500/20 transition-all group relative">
            ...
            <div class="flex items-start space-x-4 mb-4">
              ...
              <h3 class="text-xl font-bold text-white flex-grow">
                Streampai Donations <span class="text-green-400 text-sm font-normal ml-2">🚀</span>
              </h3>
            </div>
            <p class="text-gray-300 leading-relaxed mb-3">
              Accept donations directly through Streampai with industry-leading low fees. Keep more of what you earn!
            </p>
    ...
    <!-- Floating decoration -->
            <div class="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-r from-purple-500/30 to-pink-500/30 rounded-full blur-2xl">
            </div>
          </div>
        </div>
      </div>
