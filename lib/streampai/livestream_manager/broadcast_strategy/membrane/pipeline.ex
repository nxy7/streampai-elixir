defmodule Streampai.LivestreamManager.BroadcastStrategy.Membrane.Pipeline do
  ...
  """
  @spec start(pid(), pid(), String.t()) :: {:ok, pid(), pid()} | {:error, term()}
  def start(client_ref, strategy_pid, hls_output_dir) do
  ...
  def handle_init(_ctx, opts) do
    ...
    {[spec: spec, spec: audio_spec, spec: hls_video_spec, spec: hls_audio_spec], state}
  end
