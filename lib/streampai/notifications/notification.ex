defmodule Streampai.Notifications.Notification do
  ...
  actions do
    ...
    create :create do
      accept [:user_id, :content, :content_de, :content_pl, :content_es]
      primary? true
    end
  ...
  attributes do
    ...
    attribute :content, :string do
      allow_nil? false
      public? true
      description "Default content (English)"
    end

    attribute :content_de, :string do
      allow_nil? true
      public? true
      description "German translation"
    end

    attribute :content_pl, :string do
      allow_nil? true
      public? true
      description "Polish translation"
    end

    attribute :content_es, :string do
      allow_nil? true
      public? true
