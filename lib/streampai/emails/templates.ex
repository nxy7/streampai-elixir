defmodule Streampai.Emails.Templates do
  @moduledoc """
  Email templates for Streampai.

  Provides HTML and text versions of all transactional emails.
  """
  ...
  def newsletter_confirmation_html(email) do
    layout_html("""
  ...
  def newsletter_confirmation_text(email) do
    """
    You're on the list!
  ...
  def confirm_email_html(user, confirm_url) do
    name = user.name || "there"
  ...
  def confirm_email_text(user, confirm_url) do
    name = user.name || "there"
  ...
  def password_reset_html(user, reset_url) do
    name = user.name || "there"
  ...
  def password_reset_text(user, reset_url) do
    name = user.name || "there"
